...
void main()
{
	...
	*/
	...
	switch (alphabet)
	{
	case 'A':printf("A는 100~90점입니다.");
			break;
	case'B':printf("B는 90~80점입니다.");
		break;
	case'C':printf("C는 80~70점입니다");
		break;
	case'D':printf("D는 70~60점입니다.");
		break;
	case'E':printf("E는 60~50점입니다.");
		break;
